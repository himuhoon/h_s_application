...
const Button: React.FC<ButtonProps & React.ButtonHTMLAttributes<HTMLButtonElement>> = ({ 
  ...
  const variants = {
    primary: 'bg-button-1 text-button-1 hover:bg-opacity-90 active:bg-opacity-80 focus:ring-white',
    secondary: 'bg-button-2 text-global-2 hover:bg-opacity-70 active:bg-opacity-60 focus:ring-gray-300',
    outline: 'border border-global-3 text-global-3 bg-transparent hover:bg-global-3 hover:bg-opacity-20 active:bg-opacity-30 focus:ring-gray-300',
    ghost: 'text-global-1 bg-transparent hover:bg-global-1 hover:bg-opacity-10 active:bg-opacity-20 focus:ring-gray-300',
    danger: 'bg-global-4 text-global-2 hover:bg-opacity-90 active:bg-opacity-80 focus:ring-red-500'
  };
    ...
    >
      ...
      {leftImage && (
        <img 
          src={leftImage.src} 
          alt="" 
          className={`w-[${leftImage.width}px] h-[${leftImage.height}px] mr-2 sm:mr-3`}
        />
      )}
